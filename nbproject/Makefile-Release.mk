...
${OBJECTDIR}/DataMemoryChunk.o: DataMemoryChunk.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/DataMemoryChunk.o DataMemoryChunk.cpp
...
${OBJECTDIR}/NRU.o: NRU.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/NRU.o NRU.cpp
...
${OBJECTDIR}/TestApplication.o: TestApplication.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/TestApplication.o TestApplication.cpp
...
${OBJECTDIR}/VirtualMemorySwap.o: VirtualMemorySwap.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/VirtualMemorySwap.o VirtualMemorySwap.cpp
...
${TESTDIR}/tests/NRUTest.o: tests/NRUTest.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/NRUTest.o tests/NRUTest.cpp


${TESTDIR}/tests/NRUTestRunner.o: tests/NRUTestRunner.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -O2 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/NRUTestRunner.o tests/NRUTestRunner.cpp
...
${TESTDIR}/tests/VirtualMemorySwapTest.o: tests/VirtualMemorySwapTest.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -O2 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/VirtualMemorySwapTest.o tests/VirtualMemorySwapTest.cpp
...
${OBJECTDIR}/Abstr_Alarm_nomain.o: ${OBJECTDIR}/Abstr_Alarm.o Abstr_Alarm.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Abstr_Alarm_nomain.o Abstr_Alarm.cpp;\
	else  \
...
${OBJECTDIR}/Abstr_FileAllocationTable_nomain.o: ${OBJECTDIR}/Abstr_FileAllocationTable.o Abstr_FileAllocationTable.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Abstr_FileAllocationTable_nomain.o Abstr_FileAllocationTable.cpp;\
	else  \
...
${OBJECTDIR}/Abstr_FileAllocator_nomain.o: ${OBJECTDIR}/Abstr_FileAllocator.o Abstr_FileAllocator.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Abstr_FileAllocator_nomain.o Abstr_FileAllocator.cpp;\
	else  \
...
${OBJECTDIR}/Abstr_FileSystem_nomain.o: ${OBJECTDIR}/Abstr_FileSystem.o Abstr_FileSystem.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Abstr_FileSystem_nomain.o Abstr_FileSystem.cpp;\
	else  \
...
${OBJECTDIR}/Abstr_MemoryChunk_nomain.o: ${OBJECTDIR}/Abstr_MemoryChunk.o Abstr_MemoryChunk.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Abstr_MemoryChunk_nomain.o Abstr_MemoryChunk.cpp;\
	else  \
...
${OBJECTDIR}/Abstr_MemoryManager_nomain.o: ${OBJECTDIR}/Abstr_MemoryManager.o Abstr_MemoryManager.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Abstr_MemoryManager_nomain.o Abstr_MemoryManager.cpp;\
	else  \
...
${OBJECTDIR}/Abstr_Process_nomain.o: ${OBJECTDIR}/Abstr_Process.o Abstr_Process.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Abstr_Process_nomain.o Abstr_Process.cpp;\
	else  \
...
${OBJECTDIR}/Abstr_Scheduler_nomain.o: ${OBJECTDIR}/Abstr_Scheduler.o Abstr_Scheduler.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Abstr_Scheduler_nomain.o Abstr_Scheduler.cpp;\
	else  \
...
${OBJECTDIR}/Abstr_Thread_nomain.o: ${OBJECTDIR}/Abstr_Thread.o Abstr_Thread.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Abstr_Thread_nomain.o Abstr_Thread.cpp;\
	else  \
...
${OBJECTDIR}/Application_nomain.o: ${OBJECTDIR}/Application.o Application.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Application_nomain.o Application.cpp;\
	else  \
...
${OBJECTDIR}/DataMemoryChunk_nomain.o: ${OBJECTDIR}/DataMemoryChunk.o DataMemoryChunk.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/DataMemoryChunk_nomain.o DataMemoryChunk.cpp;\
	else  \
...
${OBJECTDIR}/HW_CPU_nomain.o: ${OBJECTDIR}/HW_CPU.o HW_CPU.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/HW_CPU_nomain.o HW_CPU.cpp;\
	else  \
...
${OBJECTDIR}/HW_DMA_nomain.o: ${OBJECTDIR}/HW_DMA.o HW_DMA.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/HW_DMA_nomain.o HW_DMA.cpp;\
	else  \
...
${OBJECTDIR}/HW_HardDisk_nomain.o: ${OBJECTDIR}/HW_HardDisk.o HW_HardDisk.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/HW_HardDisk_nomain.o HW_HardDisk.cpp;\
	else  \
...
${OBJECTDIR}/HW_MMU_nomain.o: ${OBJECTDIR}/HW_MMU.o HW_MMU.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/HW_MMU_nomain.o HW_MMU.cpp;\
	else  \
...
${OBJECTDIR}/HW_MMU_Continuous_nomain.o: ${OBJECTDIR}/HW_MMU_Continuous.o HW_MMU_Continuous.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/HW_MMU_Continuous_nomain.o HW_MMU_Continuous.cpp;\
	else  \
...
${OBJECTDIR}/HW_MMU_Paging_nomain.o: ${OBJECTDIR}/HW_MMU_Paging.o HW_MMU_Paging.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/HW_MMU_Paging_nomain.o HW_MMU_Paging.cpp;\
	else  \
...
${OBJECTDIR}/HW_MMU_Segmentation_nomain.o: ${OBJECTDIR}/HW_MMU_Segmentation.o HW_MMU_Segmentation.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/HW_MMU_Segmentation_nomain.o HW_MMU_Segmentation.cpp;\
	else  \
...
${OBJECTDIR}/HW_Machine_nomain.o: ${OBJECTDIR}/HW_Machine.o HW_Machine.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/HW_Machine_nomain.o HW_Machine.cpp;\
	else  \
...
${OBJECTDIR}/HW_RAM_nomain.o: ${OBJECTDIR}/HW_RAM.o HW_RAM.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/HW_RAM_nomain.o HW_RAM.cpp;\
	else  \
...
${OBJECTDIR}/HW_Timer_nomain.o: ${OBJECTDIR}/HW_Timer.o HW_Timer.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/HW_Timer_nomain.o HW_Timer.cpp;\
	else  \
...
${OBJECTDIR}/Mediator_CPU_nomain.o: ${OBJECTDIR}/Mediator_CPU.o Mediator_CPU.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Mediator_CPU_nomain.o Mediator_CPU.cpp;\
	else  \
...
${OBJECTDIR}/Mediator_DMA_nomain.o: ${OBJECTDIR}/Mediator_DMA.o Mediator_DMA.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Mediator_DMA_nomain.o Mediator_DMA.cpp;\
	else  \
...
${OBJECTDIR}/Mediator_HardDisk_nomain.o: ${OBJECTDIR}/Mediator_HardDisk.o Mediator_HardDisk.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Mediator_HardDisk_nomain.o Mediator_HardDisk.cpp;\
	else  \
...
${OBJECTDIR}/Mediator_MMU_nomain.o: ${OBJECTDIR}/Mediator_MMU.o Mediator_MMU.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Mediator_MMU_nomain.o Mediator_MMU.cpp;\
	else  \
...
${OBJECTDIR}/Mediator_Timer_nomain.o: ${OBJECTDIR}/Mediator_Timer.o Mediator_Timer.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Mediator_Timer_nomain.o Mediator_Timer.cpp;\
	else  \
...
${OBJECTDIR}/Model_nomain.o: ${OBJECTDIR}/Model.o Model.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Model_nomain.o Model.cpp;\
	else  \
...
${OBJECTDIR}/ModelBuilder_nomain.o: ${OBJECTDIR}/ModelBuilder.o ModelBuilder.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ModelBuilder_nomain.o ModelBuilder.cpp;\
	else  \
...
${OBJECTDIR}/Module_nomain.o: ${OBJECTDIR}/Module.o Module.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Module_nomain.o Module.cpp;\
	else  \
...
${OBJECTDIR}/ModuleCreate_nomain.o: ${OBJECTDIR}/ModuleCreate.o ModuleCreate.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ModuleCreate_nomain.o ModuleCreate.cpp;\
	else  \
...
${OBJECTDIR}/ModuleDispose_nomain.o: ${OBJECTDIR}/ModuleDispose.o ModuleDispose.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ModuleDispose_nomain.o ModuleDispose.cpp;\
	else  \
...
${OBJECTDIR}/ModuleInvoke_HardwareEvent_nomain.o: ${OBJECTDIR}/ModuleInvoke_HardwareEvent.o ModuleInvoke_HardwareEvent.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ModuleInvoke_HardwareEvent_nomain.o ModuleInvoke_HardwareEvent.cpp;\
	else  \
...
${OBJECTDIR}/ModuleInvoke_PulseExecution_nomain.o: ${OBJECTDIR}/ModuleInvoke_PulseExecution.o ModuleInvoke_PulseExecution.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ModuleInvoke_PulseExecution_nomain.o ModuleInvoke_PulseExecution.cpp;\
	else  \
...
${OBJECTDIR}/NRU_nomain.o: ${OBJECTDIR}/NRU.o NRU.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/NRU_nomain.o NRU.cpp;\
	else  \
...
${OBJECTDIR}/OperatingSystem_nomain.o: ${OBJECTDIR}/OperatingSystem.o OperatingSystem.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/OperatingSystem_nomain.o OperatingSystem.cpp;\
	else  \
...
${OBJECTDIR}/Page_nomain.o: ${OBJECTDIR}/Page.o Page.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Page_nomain.o Page.cpp;\
	else  \
...
${OBJECTDIR}/ProblemSolving20162ModelBuilder_nomain.o: ${OBJECTDIR}/ProblemSolving20162ModelBuilder.o ProblemSolving20162ModelBuilder.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ProblemSolving20162ModelBuilder_nomain.o ProblemSolving20162ModelBuilder.cpp;\
	else  \
...
${OBJECTDIR}/ProblemTester_nomain.o: ${OBJECTDIR}/ProblemTester.o ProblemTester.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ProblemTester_nomain.o ProblemTester.cpp;\
	else  \
...
${OBJECTDIR}/Simul_Debug_nomain.o: ${OBJECTDIR}/Simul_Debug.o Simul_Debug.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Simul_Debug_nomain.o Simul_Debug.cpp;\
	else  \
...
${OBJECTDIR}/Simul_Entity_nomain.o: ${OBJECTDIR}/Simul_Entity.o Simul_Entity.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Simul_Entity_nomain.o Simul_Entity.cpp;\
	else  \
...
${OBJECTDIR}/Simul_Event_nomain.o: ${OBJECTDIR}/Simul_Event.o Simul_Event.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Simul_Event_nomain.o Simul_Event.cpp;\
	else  \
...
${OBJECTDIR}/Simul_Statistics_nomain.o: ${OBJECTDIR}/Simul_Statistics.o Simul_Statistics.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Simul_Statistics_nomain.o Simul_Statistics.cpp;\
	else  \
...
${OBJECTDIR}/Simul_Util_nomain.o: ${OBJECTDIR}/Simul_Util.o Simul_Util.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Simul_Util_nomain.o Simul_Util.cpp;\
	else  \
...
${OBJECTDIR}/SourceModule_nomain.o: ${OBJECTDIR}/SourceModule.o SourceModule.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/SourceModule_nomain.o SourceModule.cpp;\
	else  \
...
${OBJECTDIR}/TestApplication_nomain.o: ${OBJECTDIR}/TestApplication.o TestApplication.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/TestApplication_nomain.o TestApplication.cpp;\
	else  \
...
${OBJECTDIR}/Util_Queue_nomain.o: ${OBJECTDIR}/Util_Queue.o Util_Queue.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Util_Queue_nomain.o Util_Queue.cpp;\
	else  \
...
${OBJECTDIR}/Util_Scheduling_Queue_nomain.o: ${OBJECTDIR}/Util_Scheduling_Queue.o Util_Scheduling_Queue.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Util_Scheduling_Queue_nomain.o Util_Scheduling_Queue.cpp;\
	else  \
...
${OBJECTDIR}/VirtualMemorySwap_nomain.o: ${OBJECTDIR}/VirtualMemorySwap.o VirtualMemorySwap.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/VirtualMemorySwap_nomain.o VirtualMemorySwap.cpp;\
	else  \
